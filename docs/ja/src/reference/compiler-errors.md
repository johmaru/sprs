...
| SYN-007 | `does not support struct init syntax` を含むユーザー構文解析エラー（例: `Macro '…' does not support struct init syntax. Use @init for struct initialization.`） |
