> **Documentation source of truth (updated):** User-facing docs now live in `docs/src/`. Editing `src/main.rs` crate docs and running `cargo rdme` is obsolete. Keep this file as historical implementation notes only.
